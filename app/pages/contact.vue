      ...
      <div class="contact-grid">
        <div class="contact-info">
          <div class="info-block">
            ...
            <div><strong>Adresse</strong><p>7 BIS Route de l'Ormois<br />21270 Marandeuil, France</p></div>
          </div>
          <div class="info-block">
            <span class="info-icon" v-html="icons.phone"></span>
            <div><strong>Téléphone</strong><p><a href="tel:+33620499321">06 20 49 93 21</a></p></div>
          </div>
          <div class="info-block">
            <span class="info-icon" v-html="icons.mail"></span>
            <div><strong>Email</strong><p><a href="mailto:lafermedelormois@gmail.com">lafermedelormois@gmail.com</a></p></div>
          </div>
